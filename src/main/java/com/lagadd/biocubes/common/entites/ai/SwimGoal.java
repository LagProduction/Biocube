...
import javax.annotation.Nullable;
	...
	public class SwimGoal extends RandomStrollGoal {
	    private int xzSpread;
	    private boolean submerged;
	    private int ySpread = 3;

	    public SwimGoal(PathfinderMob creature, double speed, int chance, int xzSpread) {
	        super(creature, speed, chance, false);
	        this.xzSpread = xzSpread;
	        this.submerged = false;
	    }

	    public SwimGoal(PathfinderMob creature, double speed, int chance, int xzSpread, boolean submerged) {
	        super(creature, speed, chance, false);
	        this.xzSpread = xzSpread;
	        this.submerged = submerged;
	    }

	    public SwimGoal(PathfinderMob creature, double speed, int chance, int xzSpread, int ySpread, boolean submerged) {
	        super(creature, speed, chance, false);
	        this.xzSpread = xzSpread;
