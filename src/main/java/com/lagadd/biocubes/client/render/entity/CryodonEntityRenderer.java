...
import software.bernie.geckolib3.renderers.geo.GeoEntityRenderer;
		...
		public class CryodonEntityRenderer extends GeoEntityRenderer<Cryodon> {
			...
			@Override
			public RenderType getRenderType(Cryodon animatable, float partialTicks, PoseStack stack,
